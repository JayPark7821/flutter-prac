...
class ChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var i = 0; i < 5; i++) {
      ...
      //Offset(10, size.height / 5 * i));
    }

    final spaceHour = (size.width - spacing) / infos.length;
    for (var i = 0; i < infos.length; i += 12) {
      ...
      tp.layout();
      tp.paint(canvas, Offset(i * spaceHour + 50, size.height - 5));
    }
    ...
    final fillPaint = Paint()
      ...
      ..shader = ui.Gradient.linear(
        ...
        [graphColor.withOpacity(0.5), Colors.transparent],
      );
